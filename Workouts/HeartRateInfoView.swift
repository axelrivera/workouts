        ...
        NavigationView {
            List {
                VStack(alignment: .leading, spacing: 10.0) {
                    ...
                    Text("Heart rate training uses your heart rate to measure your workout intensity while aiming for different heart rate zones depending on your fitness goals.")
                }
